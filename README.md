...
This is a SQL project showing a comprehensive analysis of global economic inequality. Using sample data modeled after World Bank indicators, I built a normalized relational database and developed **15 complex SQL queries** to extract insights on:
